...
namespace OneMessage.io.Api
{
    ...
    public partial class WebhooksApi : IWebhooksApi
    {
        ...
        /// <returns></returns>
        public WebhooksApi(OneMessage.io.Client.Configuration configuration)
        {
        ...
        public WebhooksApi(OneMessage.io.Client.ISynchronousClient client, OneMessage.io.Client.IAsynchronousClient asyncClient, OneMessage.io.Client.IReadableConfiguration configuration)
        {
        ...
        {
            OneMessage.io.Client.ApiResponse<GetAckInfo> localVarResponse = AckHookInfoWithHttpInfo(messageId);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GetAckInfo</returns>
        public OneMessage.io.Client.ApiResponse<GetAckInfo> AckHookInfoWithHttpInfo(string messageId, int operationIndex = 0)
        {
            // verify the required parameter 'messageId' is set
            if (messageId == null)
            {
                throw new OneMessage.io.Client.ApiException(400, "Missing required parameter 'messageId' when calling WebhooksApi->AckHookInfo");
            }
            ...
            localVarRequestOptions.QueryParameters.Add(OneMessage.io.Client.ClientUtils.ParameterToMultiMap("", "messageId", messageId));
        ...
        {
            OneMessage.io.Client.ApiResponse<GetAckInfo> localVarResponse = await AckHookInfoWithHttpInfoAsync(messageId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetAckInfo)</returns>
        public async System.Threading.Tasks.Task<OneMessage.io.Client.ApiResponse<GetAckInfo>> AckHookInfoWithHttpInfoAsync(string messageId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'messageId' is set
            if (messageId == null)
            {
        ...
        {
            OneMessage.io.Client.ApiResponse<SetWebhookStatus> localVarResponse = SetWebhookWithHttpInfo(webhookUrl);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SetWebhookStatus</returns>
        public OneMessage.io.Client.ApiResponse<SetWebhookStatus> SetWebhookWithHttpInfo(WebhookUrl webhookUrl, int operationIndex = 0)
        {
            // verify the required parameter 'webhookUrl' is set
            if (webhookUrl == null)
            {
                throw new OneMessage.io.Client.ApiException(400, "Missing required parameter 'webhookUrl' when calling WebhooksApi->SetWebhook");
            }
        ...
        {
            OneMessage.io.Client.ApiResponse<SetWebhookStatus> localVarResponse = await SetWebhookWithHttpInfoAsync(webhookUrl, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SetWebhookStatus)</returns>
        public async System.Threading.Tasks.Task<OneMessage.io.Client.ApiResponse<SetWebhookStatus>> SetWebhookWithHttpInfoAsync(WebhookUrl webhookUrl, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'webhookUrl' is set
            if (webhookUrl == null)
            {
