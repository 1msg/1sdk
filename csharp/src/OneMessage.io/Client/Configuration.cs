...
namespace OneMessage.io.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "{protocol}://api.1msg.io/{channelId}"},
                        {"description", "New common server url"},
                        {
                            "variables", new Dictionary<string, object> {
                                {
                                    "channelId", new Dictionary<string, object> {
        ...
        public Configuration(
            ...
            string basePath = "https://api.1msg.io/YOUR_INSTANCE_NUMBER") : this()
        {
        ...
        {
            string report = "C# SDK (OneMessage.io) Debug Report:\n";
