...
namespace OneMessage.io.Model
{
    ...
    /// MeComponents
    /// </summary>
    [DataContract(Name = "MeComponents")]
    public partial class MeComponents : IEquatable<MeComponents>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MeComponents" /> class.
        /// </summary>
        ...
        public MeComponents(string about = default(string), string address = default(string), string description = default(string), string email = default(string), string phone = default(string), VerticalEnum? vertical = default(VerticalEnum?), string photo = default(string))
        {
            this.About = about;
        ...
        {
            return this.Equals(input as MeComponents);
        }

        /// <summary>
        /// Returns true if MeComponents instances are equal
        /// </summary>
        /// <param name="input">Instance of MeComponents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MeComponents input)
        {
            if (input == null)
            {
                return false;
