...
namespace OneMessage.io.Model
{
    ...
    /// Commerce
    /// </summary>
    [DataContract(Name = "Commerce")]
    public partial class Commerce : IEquatable<Commerce>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Commerce" /> class.
        /// </summary>
        /// <param name="varParams">varParams.</param>
        public Commerce(CommerceParams varParams = default(CommerceParams))
        {
        ...
        public CommerceParams VarParams { get; set; }
        ...
        {
            return this.Equals(input as Commerce);
        }

        /// <summary>
        /// Returns true if Commerce instances are equal
        /// </summary>
        /// <param name="input">Instance of Commerce to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Commerce input)
        {
            if (input == null)
            {
                return false;
