...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class ProductsCatalogsApi : IProductsCatalogsApi
    {
        ...
        /// <returns></returns>
        public ProductsCatalogsApi(Org.OpenAPITools.Client.Configuration configuration)
        {
        ...
        public ProductsCatalogsApi(Org.OpenAPITools.Client.ISynchronousClient client, Org.OpenAPITools.Client.IAsynchronousClient asyncClient, Org.OpenAPITools.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<SendMessageStatus> localVarResponse = SendProductWithHttpInfo(sendProductRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SendMessageStatus</returns>
        public Org.OpenAPITools.Client.ApiResponse<SendMessageStatus> SendProductWithHttpInfo(SendProductRequest sendProductRequest, int operationIndex = 0)
        {
            // verify the required parameter 'sendProductRequest' is set
            if (sendProductRequest == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'sendProductRequest' when calling ProductsCatalogsApi->SendProduct");
            }
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<SendMessageStatus> localVarResponse = await SendProductWithHttpInfoAsync(sendProductRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SendMessageStatus)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<SendMessageStatus>> SendProductWithHttpInfoAsync(SendProductRequest sendProductRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'sendProductRequest' is set
            if (sendProductRequest == null)
            {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<SetCommerce> localVarResponse = SetCommerceWithHttpInfo(commerce);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SetCommerce</returns>
        public Org.OpenAPITools.Client.ApiResponse<SetCommerce> SetCommerceWithHttpInfo(Commerce commerce, int operationIndex = 0)
        {
            // verify the required parameter 'commerce' is set
            if (commerce == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'commerce' when calling ProductsCatalogsApi->SetCommerce");
            }
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<SetCommerce> localVarResponse = await SetCommerceWithHttpInfoAsync(commerce, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SetCommerce)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<SetCommerce>> SetCommerceWithHttpInfoAsync(Commerce commerce, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'commerce' is set
            if (commerce == null)
            {
