...
namespace Org.OpenAPITools.Model
{
    ...
    /// SetMeRequest
    /// </summary>
    [DataContract(Name = "SetMeRequest")]
    public partial class SetMeRequest : IEquatable<SetMeRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SetMeRequest" /> class.
        /// </summary>
        ...
        /// <param name="photo">HTTP link *https://...*  Or base64-encoded file with mime data, for example *data:image/jpeg;base64,/9j/4AAQSkZJRgABAQ...*   File in form-data input field.</param>
        public SetMeRequest(string about = default(string), string address = default(string), string description = default(string), string email = default(string), string phone = default(string), VerticalEnum? vertical = default(VerticalEnum?), string photo = default(string))
        {
            this.About = about;
        ...
        {
            return this.Equals(input as SetMeRequest);
        }

        /// <summary>
        /// Returns true if SetMeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SetMeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SetMeRequest input)
        {
            if (input == null)
            {
                return false;
