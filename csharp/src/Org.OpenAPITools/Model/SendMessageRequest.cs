...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SendMessageRequest : IEquatable<SendMessageRequest>, IValidatableObject
    {
        ...
        /// <param name="body">Message text, UTF-8 or UTF-16 string with emoji 🍏. Can be used with mentionedPhones, example: this text for @556123122026 (required).</param>
        public SendMessageRequest(string chatId = default(string), int phone = default(int), string body = default(string))
        {
        ...
        /// </summary>
        /// <value>Message text, UTF-8 or UTF-16 string with emoji 🍏. Can be used with mentionedPhones, example: this text for @556123122026</value>
