...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Contacts : IEquatable<Contacts>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="varContacts">List of checked numbers.</param>
        public Contacts(List<ContactsContactsInner> varContacts = default(List<ContactsContactsInner>))
        {
        ...
        /// </summary>
        /// <value>List of checked numbers</value>
        [DataMember(Name = "contacts", EmitDefaultValue = false)]
        public List<ContactsContactsInner> VarContacts { get; set; }
        ...
        public bool Equals(Contacts input)
        {
            ...
            return 
                (
                    this.VarContacts == input.VarContacts ||
                    this.VarContacts != null &&
                    input.VarContacts != null &&
                    this.VarContacts.SequenceEqual(input.VarContacts)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.VarContacts != null)
                {
                    hashCode = (hashCode * 59) + this.VarContacts.GetHashCode();
                }
                return hashCode;
            }
        }
