...
namespace Org.OpenAPITools.Test.Api
{
    ...
    public class WebhooksApiTests : IDisposable
    {
        ...
        /// </summary>
        [Fact]
        public void AckHookInfoTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string messageId = null;
            //var response = instance.AckHookInfo(messageId);
            //Assert.IsType<GetAckInfo>(response);
        }
        ...
        public void SetWebhookTest()
        {
            ...
            //var response = instance.SetWebhook(webhookUrl);
            //Assert.IsType<SetWebhookStatus>(response);
        }
    }
}
