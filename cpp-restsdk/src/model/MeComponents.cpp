...
#include "CppRestOpenAPIClient/model/MeComponents.h"
...
void MeComponents::validate()
{
    // TODO: implement validation
}

web::json::value MeComponents::toJson() const
{
...
bool MeComponents::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MeComponents::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MeComponents::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t MeComponents::getAbout() const
{
    return m_About;
}

void MeComponents::setAbout(const utility::string_t& value)
{
    m_About = value;
    m_AboutIsSet = true;
}

bool MeComponents::aboutIsSet() const
{
    return m_AboutIsSet;
}

void MeComponents::unsetAbout()
{
    m_AboutIsSet = false;
}
utility::string_t MeComponents::getAddress() const
{
    return m_Address;
}

void MeComponents::setAddress(const utility::string_t& value)
{
    m_Address = value;
    m_AddressIsSet = true;
}

bool MeComponents::addressIsSet() const
{
    return m_AddressIsSet;
}

void MeComponents::unsetAddress()
{
    m_AddressIsSet = false;
}
utility::string_t MeComponents::getDescription() const
{
    return m_Description;
}

void MeComponents::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool MeComponents::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void MeComponents::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t MeComponents::getEmail() const
{
    return m_Email;
}

void MeComponents::setEmail(const utility::string_t& value)
{
    m_Email = value;
    m_EmailIsSet = true;
}

bool MeComponents::emailIsSet() const
{
    return m_EmailIsSet;
}

void MeComponents::unsetEmail()
{
    m_EmailIsSet = false;
}
utility::string_t MeComponents::getPhone() const
{
    return m_Phone;
}

void MeComponents::setPhone(const utility::string_t& value)
{
    m_Phone = value;
    m_PhoneIsSet = true;
}

bool MeComponents::phoneIsSet() const
{
    return m_PhoneIsSet;
}

void MeComponents::unsetPhone()
{
    m_PhoneIsSet = false;
}
utility::string_t MeComponents::getVertical() const
{
    return m_Vertical;
}

void MeComponents::setVertical(const utility::string_t& value)
{
    m_Vertical = value;
    m_VerticalIsSet = true;
}

bool MeComponents::verticalIsSet() const
{
    return m_VerticalIsSet;
}

void MeComponents::unsetVertical()
{
    m_VerticalIsSet = false;
}
utility::string_t MeComponents::getPhoto() const
{
    return m_Photo;
}

void MeComponents::setPhoto(const utility::string_t& value)
{
    m_Photo = value;
    m_PhotoIsSet = true;
}

bool MeComponents::photoIsSet() const
{
    return m_PhotoIsSet;
}

void MeComponents::unsetPhoto()
{
    m_PhotoIsSet = false;
}
}
