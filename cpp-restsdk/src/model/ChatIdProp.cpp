...
#include "CppRestOpenAPIClient/model/ChatIdProp.h"
...
void ChatIdProp::validate()
{
    // TODO: implement validation
}

web::json::value ChatIdProp::toJson() const
{
...
bool ChatIdProp::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ChatIdProp::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ChatIdProp::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t ChatIdProp::getChatId() const
{
    return m_ChatId;
}

void ChatIdProp::setChatId(const utility::string_t& value)
{
    m_ChatId = value;
    m_ChatIdIsSet = true;
}

bool ChatIdProp::chatIdIsSet() const
{
    return m_ChatIdIsSet;
}

void ChatIdProp::unsetChatId()
{
    m_ChatIdIsSet = false;
}
}
