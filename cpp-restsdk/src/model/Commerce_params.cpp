...
void Commerce_params::validate()
{
    // TODO: implement validation
}

web::json::value Commerce_params::toJson() const
{
...
bool Commerce_params::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Commerce_params::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Commerce_params::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool Commerce_params::isIsCartEnabled() const
{
    return m_Is_cart_enabled;
}

void Commerce_params::setIsCartEnabled(bool value)
{
    m_Is_cart_enabled = value;
    m_Is_cart_enabledIsSet = true;
}

bool Commerce_params::isCartEnabledIsSet() const
{
    return m_Is_cart_enabledIsSet;
}

void Commerce_params::unsetIs_cart_enabled()
{
    m_Is_cart_enabledIsSet = false;
}
bool Commerce_params::isIsCatalogVisible() const
{
    return m_Is_catalog_visible;
}

void Commerce_params::setIsCatalogVisible(bool value)
{
    m_Is_catalog_visible = value;
    m_Is_catalog_visibleIsSet = true;
}

bool Commerce_params::isCatalogVisibleIsSet() const
{
    return m_Is_catalog_visibleIsSet;
}

void Commerce_params::unsetIs_catalog_visible()
{
    m_Is_catalog_visibleIsSet = false;
}
}
