...
void UploadMedia::validate()
{
    // TODO: implement validation
}

web::json::value UploadMedia::toJson() const
{
...
bool UploadMedia::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UploadMedia::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UploadMedia::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t UploadMedia::getBody() const
{
    return m_Body;
}

void UploadMedia::setBody(const utility::string_t& value)
{
    m_Body = value;
    m_BodyIsSet = true;
}

bool UploadMedia::bodyIsSet() const
{
    return m_BodyIsSet;
}

void UploadMedia::unsetBody()
{
    m_BodyIsSet = false;
}
}
