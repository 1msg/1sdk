...
#include "CppRestOpenAPIClient/model/TemplateNamespaceField.h"
...
TemplateNamespaceField::TemplateNamespaceField()
{
...
void TemplateNamespaceField::validate()
{
    // TODO: implement validation
}

web::json::value TemplateNamespaceField::toJson() const
{
...
bool TemplateNamespaceField::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void TemplateNamespaceField::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TemplateNamespaceField::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t TemplateNamespaceField::getRNamespace() const
{
    return m_r_namespace;
}

void TemplateNamespaceField::setRNamespace(const utility::string_t& value)
{
    m_r_namespace = value;
    m_r_namespaceIsSet = true;
}

bool TemplateNamespaceField::rNamespaceIsSet() const
{
    return m_r_namespaceIsSet;
}

void TemplateNamespaceField::unsetr_namespace()
{
    m_r_namespaceIsSet = false;
}
}
