...
void SendLocationRequest::validate()
{
    // TODO: implement validation
}

web::json::value SendLocationRequest::toJson() const
{
    ...
    if(m_LngIsSet)
    {
        val[utility::conversions::to_string_t(U("lng"))] = ModelBase::toJson(m_Lng);
    }
    if(m_AddressIsSet)
    {
...
bool SendLocationRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("lng"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("lng")));
        if(!fieldValue.is_null())
        {
...
void SendLocationRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_LngIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("lng")), m_Lng));
    }
    if(m_AddressIsSet)
    {
...
bool SendLocationRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("lng"))))
    {
        utility::string_t refVal_setLng;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("lng"))), refVal_setLng );
        setLng(refVal_setLng);
    }
...
utility::string_t SendLocationRequest::getChatId() const
{
    return m_ChatId;
}

void SendLocationRequest::setChatId(const utility::string_t& value)
{
    m_ChatId = value;
    m_ChatIdIsSet = true;
}

bool SendLocationRequest::chatIdIsSet() const
{
    return m_ChatIdIsSet;
}

void SendLocationRequest::unsetChatId()
{
    m_ChatIdIsSet = false;
}
int32_t SendLocationRequest::getPhone() const
{
    return m_Phone;
}

void SendLocationRequest::setPhone(int32_t value)
{
    m_Phone = value;
    m_PhoneIsSet = true;
}

bool SendLocationRequest::phoneIsSet() const
{
    return m_PhoneIsSet;
}

void SendLocationRequest::unsetPhone()
{
    m_PhoneIsSet = false;
}
utility::string_t SendLocationRequest::getLat() const
{
    return m_Lat;
}

void SendLocationRequest::setLat(const utility::string_t& value)
{
    m_Lat = value;
    m_LatIsSet = true;
}

bool SendLocationRequest::latIsSet() const
{
    return m_LatIsSet;
}

void SendLocationRequest::unsetLat()
{
    m_LatIsSet = false;
}
utility::string_t SendLocationRequest::getLng() const
{
    return m_Lng;
}

void SendLocationRequest::setLng(const utility::string_t& value)
{
    m_Lng = value;
    m_LngIsSet = true;
}

bool SendLocationRequest::lngIsSet() const
{
    return m_LngIsSet;
}

void SendLocationRequest::unsetLng()
{
    m_LngIsSet = false;
}
utility::string_t SendLocationRequest::getAddress() const
{
    return m_Address;
}

void SendLocationRequest::setAddress(const utility::string_t& value)
{
    m_Address = value;
    m_AddressIsSet = true;
}

bool SendLocationRequest::addressIsSet() const
{
    return m_AddressIsSet;
}

void SendLocationRequest::unsetAddress()
{
    m_AddressIsSet = false;
}
utility::string_t SendLocationRequest::getName() const
{
    return m_Name;
}

void SendLocationRequest::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool SendLocationRequest::nameIsSet() const
{
    return m_NameIsSet;
}

void SendLocationRequest::unsetName()
{
    m_NameIsSet = false;
}
}
