...
void ReadMessageRequest::validate()
{
    // TODO: implement validation
}

web::json::value ReadMessageRequest::toJson() const
{
...
bool ReadMessageRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ReadMessageRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ReadMessageRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t ReadMessageRequest::getMessageId() const
{
    return m_MessageId;
}

void ReadMessageRequest::setMessageId(const utility::string_t& value)
{
    m_MessageId = value;
    m_MessageIdIsSet = true;
}

bool ReadMessageRequest::messageIdIsSet() const
{
    return m_MessageIdIsSet;
}

void ReadMessageRequest::unsetMessageId()
{
    m_MessageIdIsSet = false;
}
}
