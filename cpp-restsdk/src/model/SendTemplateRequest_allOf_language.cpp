...
SendTemplateRequest_allOf_language::SendTemplateRequest_allOf_language()
{
...
void SendTemplateRequest_allOf_language::validate()
{
    // TODO: implement validation
}

web::json::value SendTemplateRequest_allOf_language::toJson() const
{
...
bool SendTemplateRequest_allOf_language::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("code"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<TemplateLanguageProp> refVal_setCode;
...
void SendTemplateRequest_allOf_language::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SendTemplateRequest_allOf_language::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t SendTemplateRequest_allOf_language::getPolicy() const
{
    return m_Policy;
}

void SendTemplateRequest_allOf_language::setPolicy(const utility::string_t& value)
{
    m_Policy = value;
    m_PolicyIsSet = true;
}

bool SendTemplateRequest_allOf_language::policyIsSet() const
{
    return m_PolicyIsSet;
}

void SendTemplateRequest_allOf_language::unsetPolicy()
{
    m_PolicyIsSet = false;
}
std::shared_ptr<TemplateLanguageProp> SendTemplateRequest_allOf_language::getCode() const
{
    return m_Code;
}

void SendTemplateRequest_allOf_language::setCode(const std::shared_ptr<TemplateLanguageProp>& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool SendTemplateRequest_allOf_language::codeIsSet() const
{
    return m_CodeIsSet;
}

void SendTemplateRequest_allOf_language::unsetCode()
{
    m_CodeIsSet = false;
}
}
