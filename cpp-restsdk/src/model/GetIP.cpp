...
web::json::value GetIP::toJson() const
{
...
bool GetIP::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetIP::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetIP::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t GetIP::getResult() const
{
    return m_Result;
}

void GetIP::setResult(const utility::string_t& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool GetIP::resultIsSet() const
{
    return m_ResultIsSet;
}

void GetIP::unsetResult()
{
    m_ResultIsSet = false;
}
}
