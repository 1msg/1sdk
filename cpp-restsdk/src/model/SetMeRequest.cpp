...
void SetMeRequest::validate()
{
    // TODO: implement validation
}

web::json::value SetMeRequest::toJson() const
{
...
bool SetMeRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SetMeRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SetMeRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t SetMeRequest::getAbout() const
{
    return m_About;
}

void SetMeRequest::setAbout(const utility::string_t& value)
{
    m_About = value;
    m_AboutIsSet = true;
}

bool SetMeRequest::aboutIsSet() const
{
    return m_AboutIsSet;
}

void SetMeRequest::unsetAbout()
{
    m_AboutIsSet = false;
}
utility::string_t SetMeRequest::getAddress() const
{
    return m_Address;
}

void SetMeRequest::setAddress(const utility::string_t& value)
{
    m_Address = value;
    m_AddressIsSet = true;
}

bool SetMeRequest::addressIsSet() const
{
    return m_AddressIsSet;
}

void SetMeRequest::unsetAddress()
{
    m_AddressIsSet = false;
}
utility::string_t SetMeRequest::getDescription() const
{
    return m_Description;
}

void SetMeRequest::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool SetMeRequest::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void SetMeRequest::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t SetMeRequest::getEmail() const
{
    return m_Email;
}

void SetMeRequest::setEmail(const utility::string_t& value)
{
    m_Email = value;
    m_EmailIsSet = true;
}

bool SetMeRequest::emailIsSet() const
{
    return m_EmailIsSet;
}

void SetMeRequest::unsetEmail()
{
    m_EmailIsSet = false;
}
utility::string_t SetMeRequest::getPhone() const
{
    return m_Phone;
}

void SetMeRequest::setPhone(const utility::string_t& value)
{
    m_Phone = value;
    m_PhoneIsSet = true;
}

bool SetMeRequest::phoneIsSet() const
{
    return m_PhoneIsSet;
}

void SetMeRequest::unsetPhone()
{
    m_PhoneIsSet = false;
}
utility::string_t SetMeRequest::getVertical() const
{
    return m_Vertical;
}

void SetMeRequest::setVertical(const utility::string_t& value)
{
    m_Vertical = value;
    m_VerticalIsSet = true;
}

bool SetMeRequest::verticalIsSet() const
{
    return m_VerticalIsSet;
}

void SetMeRequest::unsetVertical()
{
    m_VerticalIsSet = false;
}
utility::string_t SetMeRequest::getPhoto() const
{
    return m_Photo;
}

void SetMeRequest::setPhoto(const utility::string_t& value)
{
    m_Photo = value;
    m_PhotoIsSet = true;
}

bool SetMeRequest::photoIsSet() const
{
    return m_PhotoIsSet;
}

void SetMeRequest::unsetPhoto()
{
    m_PhotoIsSet = false;
}
}
