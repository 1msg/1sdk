...
void WebhookUrl::validate()
{
    // TODO: implement validation
}

web::json::value WebhookUrl::toJson() const
{
...
bool WebhookUrl::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void WebhookUrl::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool WebhookUrl::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t WebhookUrl::getWebhookUrl() const
{
    return m_WebhookUrl;
}

void WebhookUrl::setWebhookUrl(const utility::string_t& value)
{
    m_WebhookUrl = value;
    m_WebhookUrlIsSet = true;
}

bool WebhookUrl::webhookUrlIsSet() const
{
    return m_WebhookUrlIsSet;
}

void WebhookUrl::unsetWebhookUrl()
{
    m_WebhookUrlIsSet = false;
}
}
