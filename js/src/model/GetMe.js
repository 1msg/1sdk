...
/**
 * The GetMe model module.
 * @module model/GetMe
 * @version 2.39.0
 */
class GetMe {
    /**
     * Constructs a new <code>GetMe</code>.
     * @alias module:model/GetMe
     * @implements module:model/MeComponents
     */
    constructor() { 
        MeComponents.initialize(this);
        GetMe.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetMe</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetMe} obj Optional instance to populate.
     * @return {module:model/GetMe} The populated <code>GetMe</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>GetMe</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetMe</code>.
     */
 ...
 * @member {String} about
 */
GetMe.prototype['about'] = undefined;

/**
 * Address of the business
 * @member {String} address
 */
GetMe.prototype['address'] = undefined;

/**
 * Description of the business. Max 256 characters
 * @member {String} description
 */
GetMe.prototype['description'] = undefined;

/**
 * Business email
 * @member {String} email
 */
GetMe.prototype['email'] = undefined;

/**
 * Linked phone number
 * @member {String} phone
 */
GetMe.prototype['phone'] = undefined;

/**
 * Industry of the business
 * @member {module:model/GetMe.VerticalEnum} vertical
 */
GetMe.prototype['vertical'] = undefined;

/**
 * @member {String} photo
 */
GetMe.prototype['photo'] = undefined;
