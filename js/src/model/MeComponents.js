...
/**
 * The MeComponents model module.
 * @module model/MeComponents
 * @version 2.39.0
 */
class MeComponents {
    /**
     * Constructs a new <code>MeComponents</code>.
     * @alias module:model/MeComponents
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>MeComponents</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MeComponents} obj Optional instance to populate.
     * @return {module:model/MeComponents} The populated <code>MeComponents</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MeComponents();
    ...
    /**
     * Validates the JSON data with respect to <code>MeComponents</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MeComponents</code>.
     */
