...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1msgWabaSdk.SendTemplateRequest();
  });
  ...
  describe('SendTemplateRequest', function() {
    it('should create an instance of SendTemplateRequest', function() {
      // uncomment below and update the code to test SendTemplateRequest
      //var instance = new 1msgWabaSdk.SendTemplateRequest();
