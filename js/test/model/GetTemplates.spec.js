...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1msgWabaSdk.GetTemplates();
  });
  ...
  describe('GetTemplates', function() {
    it('should create an instance of GetTemplates', function() {
      // uncomment below and update the code to test GetTemplates
      //var instance = new 1msgWabaSdk.GetTemplates();
      //expect(instance).to.be.a(1msgWabaSdk.GetTemplates);
    });
