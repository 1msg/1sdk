...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1msgWabaSdk.SendListRequest();
  });
  ...
  describe('SendListRequest', function() {
    it('should create an instance of SendListRequest', function() {
      // uncomment below and update the code to test SendListRequest
      //var instance = new 1msgWabaSdk.SendListRequest();
      //expect(instance).to.be.a(1msgWabaSdk.SendListRequest);
    });
