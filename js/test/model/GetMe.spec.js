...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1msgWabaSdk.GetMe();
  });
  ...
  describe('GetMe', function() {
    it('should create an instance of GetMe', function() {
      // uncomment below and update the code to test GetMe
      //var instance = new 1msgWabaSdk.GetMe();
      //expect(instance).to.be.a(1msgWabaSdk.GetMe);
    });
