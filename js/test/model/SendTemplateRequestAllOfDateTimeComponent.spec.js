...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1msgWabaSdk.SendTemplateRequestAllOfDateTimeComponent();
  });
  ...
  describe('SendTemplateRequestAllOfDateTimeComponent', function() {
    it('should create an instance of SendTemplateRequestAllOfDateTimeComponent', function() {
      // uncomment below and update the code to test SendTemplateRequestAllOfDateTimeComponent
      //var instance = new 1msgWabaSdk.SendTemplateRequestAllOfDateTimeComponent();
      //expect(instance).to.be.a(1msgWabaSdk.SendTemplateRequestAllOfDateTimeComponent);
    });
