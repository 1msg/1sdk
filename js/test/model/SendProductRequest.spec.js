...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1msgWabaSdk.SendProductRequest();
  });
  ...
  describe('SendProductRequest', function() {
    it('should create an instance of SendProductRequest', function() {
      // uncomment below and update the code to test SendProductRequest
      //var instance = new 1msgWabaSdk.SendProductRequest();
      //expect(instance).to.be.a(1msgWabaSdk.SendProductRequest);
    });
