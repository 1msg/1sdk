...
/**
 * Model tests for SendProductRequest
 */
public class SendProductRequestTest {
    private final SendProductRequest model = new SendProductRequest();
