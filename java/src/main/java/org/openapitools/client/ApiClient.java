...
public class ApiClient {
    ...
    private String basePath = "https://api.1msg.io/YOUR_INSTANCE_NUMBER";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "{protocol}://api.1msg.io/{channelId}",
      "New common server url",
      new HashMap<String, ServerVariable>() {{
        put("channelId", new ServerVariable(
          "Your channel number",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2.39.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.1msg.io/YOUR_INSTANCE_NUMBER
