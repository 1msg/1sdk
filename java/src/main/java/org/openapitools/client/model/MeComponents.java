...
public class MeComponents {
  ...
  public MeComponents about(String about) {
  ...
  **/
  ...
  public MeComponents address(String address) {
  ...
  **/
  ...
  public MeComponents description(String description) {
  ...
  **/
  ...
  public MeComponents email(String email) {
  ...
  **/
  ...
  public MeComponents phone(String phone) {
  ...
  **/
  ...
  public MeComponents vertical(VerticalEnum vertical) {
  ...
  **/
  ...
  public MeComponents photo(String photo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MeComponents meComponents = (MeComponents) o;
    return Objects.equals(this.about, meComponents.about) &&
        Objects.equals(this.address, meComponents.address) &&
        Objects.equals(this.description, meComponents.description) &&
        Objects.equals(this.email, meComponents.email) &&
        Objects.equals(this.phone, meComponents.phone) &&
        Objects.equals(this.vertical, meComponents.vertical) &&
        Objects.equals(this.photo, meComponents.photo);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to MeComponents
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MeComponents.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MeComponents is not found in the empty JSON string", MeComponents.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MeComponents.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MeComponents` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MeComponents.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MeComponents' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MeComponents> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MeComponents.class));

       return (TypeAdapter<T>) new TypeAdapter<MeComponents>() {
           @Override
           public void write(JsonWriter out, MeComponents value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MeComponents read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of MeComponents given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MeComponents
  * @throws IOException if the JSON string is invalid with respect to MeComponents
  */
  public static MeComponents fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MeComponents.class);
  }

 /**
  * Convert an instance of MeComponents to an JSON string
  *
  * @return JSON string
  */
