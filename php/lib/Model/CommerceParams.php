...
/**
 * CommerceParams Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CommerceParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Commerce_params';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_cart_enabled'] === null) {
            $invalidProperties[] = "'is_cart_enabled' can't be null";
        }
        if ($this->container['is_catalog_visible'] === null) {
            $invalidProperties[] = "'is_catalog_visible' can't be null";
        }
     ...
     *
     * @param bool $is_cart_enabled is_cart_enabled
     *
     * @return self
     */
     ...
     *
     * @param bool $is_catalog_visible is_catalog_visible
     *
     * @return self
     */
