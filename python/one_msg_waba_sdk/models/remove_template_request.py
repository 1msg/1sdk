...
class RemoveTemplateRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RemoveTemplateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RemoveTemplateRequest:
        """Create an instance of RemoveTemplateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RemoveTemplateRequest.parse_obj(obj)

        _obj = RemoveTemplateRequest.parse_obj({
            "name": obj.get("name")
        })
        return _obj
