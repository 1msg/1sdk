...
class SendListRequestAllOfSections(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SendListRequestAllOfSections:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SendListRequestAllOfSections:
        """Create an instance of SendListRequestAllOfSections from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SendListRequestAllOfSections.parse_obj(obj)

        _obj = SendListRequestAllOfSections.parse_obj({
            "title": obj.get("title"),
