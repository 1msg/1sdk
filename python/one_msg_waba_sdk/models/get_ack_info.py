...
class GetAckInfo(BaseModel):
    ...
    GetAckInfo
    """
    hooks: Optional[conlist(GetAckInfoHooksInner)] = None
    __properties = ["hooks"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAckInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAckInfo:
        """Create an instance of GetAckInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAckInfo.parse_obj(obj)

        _obj = GetAckInfo.parse_obj({
