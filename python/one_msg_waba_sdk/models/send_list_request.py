...
class SendListRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SendListRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SendListRequest:
        """Create an instance of SendListRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SendListRequest.parse_obj(obj)

        _obj = SendListRequest.parse_obj({
