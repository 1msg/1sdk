...
class Commerce(BaseModel):
    ...
    Commerce
    """
    params: Optional[CommerceParams] = None
    __properties = ["params"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Commerce:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Commerce:
        """Create an instance of Commerce from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Commerce.parse_obj(obj)

        _obj = Commerce.parse_obj({
