...
class SendProductRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SendProductRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SendProductRequest:
        """Create an instance of SendProductRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SendProductRequest.parse_obj(obj)

        _obj = SendProductRequest.parse_obj({
            "chat_id": obj.get("chatId"),
            "phone": obj.get("phone"),
            "action": SendProductRequestAllOfAction.from_dict(obj.get("action")) if obj.get("action") is not None else None,
            "body": obj.get("body"),
