...
class TestSendTemplateRequestAllOfParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendTemplateRequestAllOfParams:
        """Test SendTemplateRequestAllOfParams
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendTemplateRequestAllOfParams`
        """
        model = SendTemplateRequestAllOfParams()  # noqa: E501
        if include_optional:
    ...
    def testSendTemplateRequestAllOfParams(self):
        """Test SendTemplateRequestAllOfParams"""
