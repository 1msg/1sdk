...
class TestGetTemplatesTemplatesInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTemplatesTemplatesInner:
        """Test GetTemplatesTemplatesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTemplatesTemplatesInner`
        """
        model = GetTemplatesTemplatesInner()  # noqa: E501
        if include_optional:
    ...
    def testGetTemplatesTemplatesInner(self):
        """Test GetTemplatesTemplatesInner"""
