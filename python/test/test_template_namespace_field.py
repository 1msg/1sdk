...
class TestTemplateNamespaceField(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TemplateNamespaceField:
        """Test TemplateNamespaceField
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TemplateNamespaceField`
        """
        model = TemplateNamespaceField()  # noqa: E501
        if include_optional:
            return TemplateNamespaceField(
    ...
    def testTemplateNamespaceField(self):
        """Test TemplateNamespaceField"""
