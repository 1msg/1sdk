...
class TestGetMe401Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetMe401Response:
        """Test GetMe401Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMe401Response`
        """
        model = GetMe401Response()  # noqa: E501
        if include_optional:
            return GetMe401Response(
