...
class TestSendProductRequestAllOfActionSections(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendProductRequestAllOfActionSections:
        ...
        # uncomment below to create an instance of `SendProductRequestAllOfActionSections`
        """
        model = SendProductRequestAllOfActionSections()  # noqa: E501
        if include_optional:
    ...
    def testSendProductRequestAllOfActionSections(self):
        """Test SendProductRequestAllOfActionSections"""
