...
class TestTemplateComponentsPropInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TemplateComponentsPropInner:
        """Test TemplateComponentsPropInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TemplateComponentsPropInner`
        """
        model = TemplateComponentsPropInner()  # noqa: E501
        if include_optional:
            return TemplateComponentsPropInner(
                type = 'BODY',
                format = 'TEXT',
                text = 'header text {{1}}',
    ...
    def testTemplateComponentsPropInner(self):
        """Test TemplateComponentsPropInner"""
