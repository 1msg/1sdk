...
class TestSendTemplateRequestAllOfDateTime(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendTemplateRequestAllOfDateTime:
        """Test SendTemplateRequestAllOfDateTime
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendTemplateRequestAllOfDateTime`
        """
    ...
    def testSendTemplateRequestAllOfDateTime(self):
        """Test SendTemplateRequestAllOfDateTime"""
