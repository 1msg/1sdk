...
class TestSetWebhookStatus(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SetWebhookStatus:
        """Test SetWebhookStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetWebhookStatus`
        """
        model = SetWebhookStatus()  # noqa: E501
        if include_optional:
            return SetWebhookStatus(
                set = True,
                message = 'https://bin.1msg.io/1f9aj261'
            )
        else:
            return SetWebhookStatus(
        )
