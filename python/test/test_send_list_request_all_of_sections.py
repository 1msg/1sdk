...
class TestSendListRequestAllOfSections(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendListRequestAllOfSections:
        """Test SendListRequestAllOfSections
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendListRequestAllOfSections`
        """
        model = SendListRequestAllOfSections()  # noqa: E501
        if include_optional:
    ...
    def testSendListRequestAllOfSections(self):
        """Test SendListRequestAllOfSections"""
