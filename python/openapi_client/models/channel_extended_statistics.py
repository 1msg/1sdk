...
class ChannelExtendedStatistics(ChannelExtendedStatisticsInner):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChannelExtendedStatistics:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChannelExtendedStatistics:
        """Create an instance of ChannelExtendedStatistics from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChannelExtendedStatistics.parse_obj(obj)
