...
class PhoneProp(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PhoneProp:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PhoneProp:
        """Create an instance of PhoneProp from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PhoneProp.parse_obj(obj)

        _obj = PhoneProp.parse_obj({
            "phone": obj.get("phone")
        })
        return _obj
