...
class SetSettings200Response(BaseModel):
    ...
    update: SetSettings200ResponseAllOfUpdate = Field(...)
    __properties = ["webhookUrl", "update"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SetSettings200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SetSettings200Response:
        """Create an instance of SetSettings200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SetSettings200Response.parse_obj(obj)

        _obj = SetSettings200Response.parse_obj({
