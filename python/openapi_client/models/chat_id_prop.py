...
class ChatIdProp(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChatIdProp:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChatIdProp:
        """Create an instance of ChatIdProp from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChatIdProp.parse_obj(obj)

        _obj = ChatIdProp.parse_obj({
