 ...
 */
export interface SetMeRequest {
    /**
     * Profile`s About section.
     * @type {string}
     * @memberof SetMeRequest
     */
    about?: string;
    /**
     ...
     * @memberof SetMeRequest
     */
    vertical?: SetMeRequestVerticalEnum;
    /**
     * HTTP link
     * *https://...*
     * 
 ...
 * @export
 */
export const SetMeRequestVerticalEnum = {
...
export type SetMeRequestVerticalEnum = typeof SetMeRequestVerticalEnum[keyof typeof SetMeRequestVerticalEnum];


/**
 * Check if a given object implements the SetMeRequest interface.
 */
export function instanceOfSetMeRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SetMeRequestFromJSON(json: any): SetMeRequest {
    return SetMeRequestFromJSONTyped(json, false);
}

export function SetMeRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SetMeRequest {
...
export function SetMeRequestToJSON(value?: SetMeRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
