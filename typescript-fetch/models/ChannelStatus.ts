...
export interface ChannelStatus {
     ...
     */
    status?: ChannelStatusStatusEnum;
}
 ...
 * @export
 */
export const ChannelStatusStatusEnum = {
    Connected: 'connected',
...
export type ChannelStatusStatusEnum = typeof ChannelStatusStatusEnum[keyof typeof ChannelStatusStatusEnum];


/**
 * Check if a given object implements the ChannelStatus interface.
 */
export function instanceOfChannelStatus(value: object): boolean {
    let isInstance = true;
