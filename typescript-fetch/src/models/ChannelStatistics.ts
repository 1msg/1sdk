...
export interface ChannelStatistics {
     ...
     * @memberof ChannelStatistics
     */
    templatesCost?: number;
}

/**
 * Check if a given object implements the ChannelStatistics interface.
 */
export function instanceOfChannelStatistics(value: object): boolean {
    let isInstance = true;
...
export function ChannelStatisticsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChannelStatistics {
    ...
    return {
        ...
        'templatesCost': !exists(json, 'templates_cost') ? undefined : json['templates_cost'],
    };
}
...
export function ChannelStatisticsToJSON(value?: ChannelStatistics | null): any {
    ...
    return {
        ...
        'date': value.date,
        'templates_cost': value.templatesCost,
    };
}
